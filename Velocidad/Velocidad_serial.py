...
plt.savefig('./vel_{}_{}.svg'.format(Reynolds, alto))


pd.DataFrame(Vprom[:,:,0]).to_csv('./vel_v_{}_{}.csv'.format(Reynolds, alto), index=False)
pd.DataFrame(Vprom[:,:,1]).to_csv('./vel_u_{}_{}.csv'.format(Reynolds, alto), index=False)
